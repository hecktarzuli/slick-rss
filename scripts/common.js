...
function FormatDate(dt, format) {
    ...
    // [u]      Makes the output use GMT. (Otherwise local)
    ...
    // [12hh]   Hours in zero padded 12 hour format
    // [12h]    The hour in 12 hour format
